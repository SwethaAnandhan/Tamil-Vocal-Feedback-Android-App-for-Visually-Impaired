...
import com.example.tamilvoice.helpers.BoxWithText;
//import com.example.yourfriend.ImageHelperActivity;
                ...
                .addOnSuccessListener(
                        detectedObjects -> {
                            ...
                            if (detectedObjects.isEmpty()) {
                                getOutputTextView().setText(String.format("Could not detect!!"));
                            } else {
                                getOutputTextView().setText(String.format(sb.toString()));
                            }
                        })
