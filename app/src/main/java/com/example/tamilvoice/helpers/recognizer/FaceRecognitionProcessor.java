package com.example.tamilvoice.helpers.recognizer;
...
import com.example.tamilvoice.helpers.recognizer.FaceGraphic;
import com.example.tamilvoice.helpers.recognizer.GraphicOverlay;
import com.example.tamilvoice.helpers.recognizer.VisionBaseProcessor;
import com.example.tamilvoice.FaceRecognitionActivity;
...
public class FaceRecognitionProcessor extends VisionBaseProcessor<List<Face>> {
    ...
    public FaceRecognitionProcessor(Context context, Interpreter faceNetModelInterpreter,
        ...
        FaceDetectorOptions faceDetectorOptions = new FaceDetectorOptions.Builder()
                ...
                // to ensure we don't count and analyze the same person again
                .enableTracking()
                .build();
        detector = FaceDetection.getClient(faceDetectorOptions);
    }
    private void speakOut(String name) {
        textToSpeech.speak("இது " + name, TextToSpeech.QUEUE_FLUSH, null, "face_recognition");
    }
